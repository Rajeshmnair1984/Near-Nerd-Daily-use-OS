    ...
    <div className="matrix-form-overlay" role="presentation" onClick={onCancel}>
      ...
      >
        ...
        <div className="matrix-header">
          ...
          <button onClick={onCancel} className="icon-button" aria-label="Abort and close matrix">
            <X size={20} aria-hidden="true" />
          </button>
        </div>

        <div className="matrix-body">
          <aside className="matrix-sidebar" role="tablist" aria-label="Matrix sections">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                role="tab"
            ...
            <div className="matrix-sidebar-footer" role="status" aria-label="Completion progress">
              <p className="progress-label">Completion</p>
              <div className="progress-track">
                <div className="progress-fill" style={{ width: `${completionPercentage}%` }}></div>
              </div>
              <p className="progress-text">{completionPercentage}% Coordinates Locked</p>
            </div>
          </aside>
            ...
            <form id="matrix-form" onSubmit={handleSubmit}>
              <AnimatePresence mode="wait">
                {activeTab === 'identity' && (
                  ...
                  >
                    <div className="matrix-section-title">
                      <h2><Building2 size={22} className="text-primary" aria-hidden="true" /> Store Master Identity</h2>
                    </div>
                    
                    <div className="form-grid">
                      <div className="form-group full-width">
                        <label className="form-label" htmlFor="matrix-loc-name">LOCATION NAME</label>
                        <input id="matrix-loc-name" name="name" required aria-required="true" className="form-input" value={formData.name} onChange={handleChange} placeholder="e.g. Near Nerd Global HQ" />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-store-code">STORE CODE</label>
                        <input id="matrix-store-code" name="store_code" className="form-input" value={formData.store_code} onChange={handleChange} placeholder="NN-XXX" />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-brand-name">BRAND NAME</label>
                        <input id="matrix-brand-name" name="brand_name" className="form-input" value={formData.brand_name} onChange={handleChange} placeholder="Official Brand Identity" />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-opening-date">OPENING DATE</label>
                        <input id="matrix-opening-date" name="opening_date" type="date" className="form-input" value={formData.opening_date} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-ops-status">OPERATIONAL STATUS</label>
                        <select id="matrix-ops-status" name="operational_status" className="form-select" value={formData.operational_status} onChange={handleChange}>
                ...
                {activeTab === 'location' && (
                  ...
                  >
                    <div className="matrix-section-title">
                      <h2><MapPin size={22} aria-hidden="true" /> Geographic & Landlord</h2>
                      <IntelSyncBadge 
                    ...
                    <div className="form-grid">
                      <div className="form-group full-width">
                        ...
                        <input id="matrix-street" name="street_address" className="form-input" value={formData.street_address} onChange={handleChange} placeholder="Unit #, Street Address" />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-city">CITY</label>
                        <input id="matrix-city" name="city" className="form-input" value={formData.city} onChange={handleChange} />
                      </div>
                      <div className="form-grid-compact">
                        <div className="form-group">
                          <label className="form-label" htmlFor="matrix-province">PROVINCE</label>
                          <input id="matrix-province" name="province" className="form-input" value={formData.province} onChange={handleChange} />
                        </div>
                        <div className="form-group">
                          <label className="form-label" htmlFor="matrix-postal">POSTAL CODE</label>
                          <input id="matrix-postal" name="postal_code" className="form-input" value={formData.postal_code} onChange={handleChange} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="form-grid">
                      <div className="form-group">
                        ...
                        <input id="matrix-landlord-co" name="landlord_company" className="form-input" value={formData.landlord_company} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-landlord-name">PRIMARY CONTACT NAME</label>
                        <input id="matrix-landlord-name" name="landlord_name" className="form-input" value={formData.landlord_name} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-landlord-email">EMAIL ADDRESS</label>
                        <input id="matrix-landlord-email" name="landlord_email" type="email" className="form-input" value={formData.landlord_email} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-landlord-phone">PHONE NUMBER</label>
                        <input id="matrix-landlord-phone" name="landlord_phone" className="form-input" value={formData.landlord_phone} onChange={handleChange} />
                      </div>
                    </div>
                ...
                {activeTab === 'lease' && (
                  ...
                  >
                    <div className="matrix-section-title">
                      <h2><Scale size={22} aria-hidden="true" /> Lease & Financials</h2>
                      <IntelSyncBadge 
                    ...
                    <div className="form-grid-3">
                      <div className="form-group">
                        ...
                        <input id="matrix-lease-start" name="lease_start" type="date" className="form-input" value={formData.lease_start} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-lease-expiry">LEASE EXPIRY</label>
                        <input id="matrix-lease-expiry" name="lease_expiry" type="date" className="form-input" value={formData.lease_expiry} onChange={handleChange} />
                      </div>
                      <div className="form-grid-compact">
                        <div className="form-group">
                          <label className="form-label" htmlFor="matrix-lease-term">TERM (YRS)</label>
                          <input id="matrix-lease-term" name="lease_term_years" type="number" className="form-input" value={formData.lease_term_years} onChange={handleChange} />
                        </div>
                        <div className="form-group">
                          <label className="form-label" htmlFor="matrix-lease-notice">NOTICE (MOS)</label>
                          <input id="matrix-lease-notice" name="lease_notice_months" type="number" className="form-input" value={formData.lease_notice_months} onChange={handleChange} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="form-grid-3">
                      <div className="form-group">
                        ...
                        <div className="currency-input-wrap">
                          ...
                          <input id="matrix-base-rent" name="base_rent" type="number" className="form-input currency-input" value={formData.base_rent} onChange={handleChange} />
                        </div>
                      </div>
                      <div className="form-group">
                        ...
                        <div className="currency-input-wrap">
                          <span className="currency-symbol" aria-hidden="true">$</span>
                          <input id="matrix-cam-rent" name="additional_rent_cam" type="number" className="form-input currency-input" value={formData.additional_rent_cam} onChange={handleChange} />
                        </div>
                      </div>
                      <div className="form-group">
                        ...
                        <div className="currency-input-wrap">
                          <span className="currency-symbol" aria-hidden="true">$</span>
                          <input id="matrix-deposit" name="deposit_amount" type="number" className="form-input currency-input" value={formData.deposit_amount} onChange={handleChange} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <textarea id="matrix-renewal-terms" name="renewal_terms" className="form-textarea textarea-matrix" value={formData.renewal_terms} onChange={handleChange} placeholder="Outline renewal options, indexation, and special conditions..." />
                    </div>

                    <div className="upload-zone-matrix">
                      <FileText size={32} color="var(--text-secondary)" className="upload-icon-matrix" aria-hidden="true" />
                      ...
                      <button type="button" className="button-secondary upload-btn-matrix">Select File</button>
                    </div>
                  </motion.div>
                )}
                ...
                {activeTab === 'insurance' && (
                  ...
                  >
                    <div className="matrix-section-title">
                      <h2><ShieldCheck size={22} aria-hidden="true" /> Insurance & Compliance</h2>
                      <IntelSyncBadge 
                    ...
                    <div className="form-grid">
                      <div className="form-group">
                        ...
                        <input id="matrix-ins-carrier" name="insurance_company" className="form-input" value={formData.insurance_company} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-policy-num">POLICY NUMBER</label>
                        <input id="matrix-policy-num" name="policy_number" className="form-input" value={formData.policy_number} onChange={handleChange} />
                      </div>
                    </div>
                    ...
                    <div className="form-grid-3">
                      <div className="form-group">
                        ...
                        <div className="compliance-icon-wrap">
                          <Clock size={16} className="compliance-icon" aria-hidden="true" />
                          <input id="matrix-license-expiry" name="biz_license_expiry" type="date" className="form-input" value={formData.biz_license_expiry} onChange={handleChange} />
                        </div>
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-fire-inspect">FIRE INSPECTION DUE</label>
                        <div className="compliance-icon-wrap">
                          <Flame size={16} className="compliance-icon" aria-hidden="true" />
                          <input id="matrix-fire-inspect" name="fire_inspection_due" type="date" className="form-input" value={formData.fire_inspection_due} onChange={handleChange} />
                        </div>
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-fire-ext">FIRE EXT. EXPIRY</label>
                        <input id="matrix-fire-ext" name="fire_extinguisher_expiry" type="date" className="form-input" value={formData.fire_extinguisher_expiry} onChange={handleChange} />
                      </div>
                    </div>

                    <div className="matrix-info-box matrix-info-box-danger" role="alert">
                      <AlertCircle size={16} aria-hidden="true" />
                      <p>Missing compliance dates will trigger "High Risk" status in the Master Operations Dashboard.</p>
                    </div>
                  </motion.div>
                )}
                  ...
                  >
                    ...
                    <div className="form-grid">
                      <div className="form-group full-width">
                        ...
                        <input id="matrix-mgr-name" name="store_manager_name" className="form-input" value={formData.store_manager_name} onChange={handleChange} placeholder="Full Legal Name" />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-mgr-email">MANAGER EMAIL</label>
                        <input id="matrix-mgr-email" name="manager_email" type="email" className="form-input" value={formData.manager_email} onChange={handleChange} placeholder="nn.manager@nearnerd.com" />
                      </div>
                      <div className="form-group">
                        <label className="form-label" htmlFor="matrix-mgr-phone">MANAGER PHONE</label>
                        <input id="matrix-mgr-phone" name="manager_phone" className="form-input" value={formData.manager_phone} onChange={handleChange} />
                      </div>
                      <div className="form-group">
                        ...
                        <div className="staff-input-wrap">
                          ...
                          <input id="matrix-staff-count" name="staff_count" type="number" className="form-input" value={formData.staff_count} onChange={handleChange} />
                        </div>
                      </div>
                    </div>

                    <div className="ops-finalize-banner" role="complementary">
                      <div className="ops-finalize-icon-wrap" aria-hidden="true">
        ...
        <div className="matrix-footer">
          <button type="button" className="button-secondary footer-abort-btn" onClick={onCancel}>
            ABORT
          </button>
