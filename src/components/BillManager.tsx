...
const statusOptions: Array<BillStatus | "All"> = [
  "All",
  "Paid",
  "Pending",
  "Overdue",
    ...
    () =>
      bills.filter((bill) => {
        ...
        const matchesLocation =
          filterLocation === "All" || bill.location_id === filterLocation;
        const matchesVendor =
          filterVendor === "All" || bill.vendor_id === filterVendor;
    ...
    <div className="page-shell bill-matrix-page">
      ...
      <header className="page-hero">
        <div className="hero-content">
          ...
          <p>
            Global oversight of commitments, recurring liabilities, and
        ...
        <button
          ...
          aria-label="Initialize new bill"
        >
      ...
      <div
        ...
        role="list"
        aria-label="Financial summaries"
      >
      ...
      <section
        className="panel bill-panel"
        aria-labelledby="bill-manager-title"
      >
        ...
        <div className="bill-toolbar-premium">
          <div className="main-tools">
            ...
            <div
              className="segmented-control segmented-control-wrapper"
              role="group"
          ...
          <div className="stats-row">
            <p className="stats-text" role="status">
              IDENTIFIED{" "}
              <span className="stats-count">{filteredBills.length}</span>{" "}
              LIABILITIES
            </p>
            <div
              className="export-group"
              role="group"
              aria-label="Export orchestration data"
            >
              <button
              ...
              <button
                className="export-button"
                onClick={() =>
                  exportService.exportBillsSummaryToCSV(filteredBills)
                }
                aria-label="Export summary to CSV"
              >
                <Download size={14} aria-hidden="true" /> SUMMARY
              </button>
              <button
                className="export-button"
                onClick={() => exportService.exportBillsToText(filteredBills)}
                aria-label="Export to text report"
              >
                <Download size={14} aria-hidden="true" /> REPORT
              </button>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          <div className="empty-state" aria-busy="true" aria-live="polite">
            Synchronizing Financial Matrix...
          </div>
        ) : (
            ...
            {filteredBills.length === 0 && (
              <div className="empty-state empty-state-container">
                ...
                <h3 className="empty-state-title">
                  No Financial Coordinates Found
                </h3>
                <p className="empty-state-sub">
                  Adjust your filters or initialize a new liability entry.
                </p>
              </div>
            )}
          </div>
